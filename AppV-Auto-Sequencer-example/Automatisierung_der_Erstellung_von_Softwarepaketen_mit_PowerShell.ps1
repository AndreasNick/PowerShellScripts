...
# 5 Minutes
$deltatime = [System.Diagnostics.Stopwatch]::StartNew()
New-BatchAppVSequencerPackages -ConfigFile "C:\packages\autoseq.xml" -VMName "SEQ2" -OutputPath "C:\packages\output\" -Verbose
$deltatime.Elapsed


Connect-AppVSequencerVM -VMName SEQ2
...
Add-AppvClientPackage C:\Packages\output\Free_AppDeploy_Repackager\Free_AppDeploy_Repackager.appv | Publish-AppvClientPackage

Get-AppvClientPackage free* | Remove-AppvClientPackage
